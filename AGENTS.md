...
This project uses CI pipelines to validate PR's. When requested to create a branch and PR, also enable automerge.

Auto-merge test 2: 2026-07-13 — verifying automerge with main branch rules enforced.
